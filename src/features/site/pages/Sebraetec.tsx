  ...
  const faqs = [
    {
      ...
      a: "O SEBRAETEC é um programa nacional do SEBRAE que visa facilitar o acesso de micro e pequenas empresas à inovação e tecnologia. Ele conecta sua empresa a prestadores de serviços tecnológicos registrados, como a TAG08, e subsidia até 70% ou 80% do valor total do projeto."
    },
    {
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            {[
              ...
              { num: "03", term: "ENVIO & ANÁLISE", desc: "Submetemos o projeto ao SEBRAE para análise e emissão do termo de concessão com liberação do subsídio." },
              { num: "04", term: "EXECUÇÃO DE ELITE", desc: "Com a anuência oficial, iniciamos o projeto. Entregamos toda a maturidade de design e web da nossa equipe." },
              { num: "05", term: "HOMOLOGAÇÃO", desc: "Você recebe o projeto finalizado, pronto e validado em faturamento ativo. O SEBRAE quita a parcela subsidiada." }
            ].map((step, sIdx) => (
      ...
      <section className="px-4 sm:px-6 md:px-8 max-w-7xl mx-auto pt-8">
        <div className="border border-white/[0.08] bg-gradient-to-br from-charcoal-900 to-black rounded-[32px] p-8 sm:p-12 md:p-16 text-center space-y-6 relative overflow-hidden">
          ...
          <p className="text-zinc-400 text-xs sm:text-sm font-medium max-w-2xl mx-auto z-10 leading-relaxed">
            Nossos consultores credenciados estão à disposição de sua marca para dar prioridade e celeridade ao seu diagnóstico cadastral. Pague menos, modernize mais e capte o real potencial comercial do seu CNPJ.
          </p>
