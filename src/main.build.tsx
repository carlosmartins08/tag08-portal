...
if (!rootElement) {
  const message = "Elemento raiz #root ṇo encontrado. A aplica̤̣o ṇo pode iniciar.";
  ...
  document.body.innerHTML = `
    <main style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:#0a0a0a;color:#f5f5f5;font-family:system-ui,sans-serif;padding:24px;text-align:center">
      <div>
        ...
        <p style="max-width:560px;margin:0 auto;color:#d4d4d8">Verifique se o HTML de entrada cont̩m <code>#root</code> antes de iniciar o React.</p>
      </div>
    </main>
  `;
} else {
