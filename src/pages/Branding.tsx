                        ...
                        onClick={() => {
                          ...
                          if (previewCard && previewTitle && previewTagline && previewBadge && previewValues && previewFit) {
                            if (guide.id === "identidade") {
                              ...
                              previewTagline.innerText = "Base visual da marca para manter a leitura consistente em qualquer peça.";
                              ...
                              previewFit.innerText = "Manual base, time interno e parceiros de produção";
                              ...
                              previewTitle.innerText = "Critérios de consistência";
                              previewTagline.innerText = "O que precisa seguir igual para a marca continuar reconhecível.";
                              previewTagline.className = "text-zinc-400 font-serif text-xs leading-relaxed";
                              previewBadge.innerText = "CONSISTÊNCIA";
                              ...
                              previewValues.innerText = "Ritmo visual\nEscala e contraste\nAlinhamento\nUso repetido dos mesmos critérios";
                              previewFit.innerText = "Novas peças, campanhas e atualizações do dia a dia";
                            } else {
                  ...
                  >
                    ...
                    <div className="space-y-4 my-6">
                      ...
                      <p id="preview-tagline" className="text-zinc-400 font-sans text-xs leading-relaxed">
                        Base visual da marca para manter a leitura consistente em qualquer peça.
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t border-white/[0.05] pt-4 text-xs font-sans">
                      ...
                      <div>
                        ...
                        <p id="preview-fit" className="text-zinc-300 text-[10px] mt-1 leading-normal font-sans">
                          Manual base, time interno e parceiros de produção
                        </p>
                      </div>
                    </div>
                  </div>
