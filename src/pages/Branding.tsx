...
export default function Branding({ onNavigate }: BrandingProps) {
  ...
  return (
    <div className="bg-charcoal-950 text-white min-h-screen pt-28 pb-20 relative overflow-hidden">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between space-y-8 text-left h-full relative z-10 lg:pl-4">
            <div className="space-y-4">
              ...
              <h2 className="font-display font-black text-4xl sm:text-5xl lg:text-6xl text-black leading-[0.9] tracking-tighter uppercase font-display">
                SISTEMA VISUAL <br />
                Sï¿½ï¿½&ï¿½NIOR E CONCEITUAL!
              </h2>
              <p className="text-black/85 text-[11px] sm:text-xs max-w-lg leading-relaxed font-sans font-extrabold uppercase">
                ELEVE A REPUTAï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O DO SEU NEGï¿½ï¿½ï¿½ï¿½ï¿½CIO COM A HERï¿½LDICA, TIPOGRAFIAS CONCEITUAIS SELECIONADAS E UMA PALETA EXCLUSIVA DESENHADA PARA ATRAIR EXCLUSIVAMENTE CLIENTES Sï¿½ï¿½&ï¿½NIOR E DE GRANDE ESCALA.
              </p>
            </div>
            ...
            <div className="bg-charcoal-900/98 backdrop-blur-3xl border border-white/[0.08] p-6 sm:p-7 rounded-[28px] shadow-[0_25px_60px_rgba(0,0,0,0.5)] space-y-6 max-w-md relative overflow-hidden text-left">
              ...
              <div className="flex gap-4 items-start select-none">
                ...
                <div className="space-y-0.5">
                  <span className="font-mono text-[8px] text-brand uppercase tracking-wider font-extrabold block">
                    EQUILҍBRIO COGNITIVO
                  </span>
                  <p className="text-white text-xs leading-snug font-sans font-semibold">
                    Substitua logotipos clichês por marcas expressivas e minimalistas que impõem autoridade intelectual imediata perante concorrentes.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <a 
                  href={buildBrazilWhatsAppUrl("Olá,%20gostaria%20de%20solicitar%20um%20diagnóstico%20de%20branding%20com%20a%20TAG08")}
                  target="_blank"
                  rel="noreferrer"
                  onClick={() => handleOutboundClick("WhatsApp", buildBrazilWhatsAppUrl("Olá,%20gostaria%20de%20solicitar%20um%20diagnóstico%20de%20branding%20com%20a%20TAG08"), "branding-diagnosis-br")}
              ...
              <div className="flex items-center justify-between border-t border-white/[0.05] pt-4 text-xs">
                ...
                <span className="font-sans text-[8.5px] text-brand font-bold bg-brand/10 border border-brand/20 px-2 rounded">
                  OPERAï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O ATIVA 100% online
                </span>
              </div>
            </div>
          </div>
      ...
      {/* SECTION 4 - SOLUTIONS & RICH GUIDES (ENTREGï¿½VEIS FINOS, EVOLUï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O E FECHAMENTO) */}
      <section className="py-24 px-4 sm:px-6 md:px-8 border-b border-white/[0.04] bg-neutral-900/10 text-left">
        <div className="max-w-7xl mx-auto space-y-28">

          {/* INTERACTIVE INNOVATION: SIMULADOR DE ARQUï¿½ï¿½ï¿½ï¿½ï¿½TIPOS E DIREï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O VISUAL */}
          <div className="space-y-12">
            <div className="space-y-3 max-w-3xl">
              <span className="font-mono text-[9px] text-brand-secondary uppercase tracking-widest font-semibold bg-brand-secondary/5 border border-brand-secondary/15 px-2.5 py-1 rounded-md inline-block">
                DIREï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O CRIATIVA // SIMULADOR DE POSICIONAMENTO
              </span>
              <h2 className="font-display font-medium text-3xl text-white uppercase tracking-tight">
                Simulador de Arquétipos e Direção de Marca
              </h2>
              <p className="text-zinc-400 text-xs sm:text-sm font-sans leading-relaxed">
                Marcas líderes de faturamento não surgem por acaso; elas são construídas sobre pilares psicológicos fortes. Escolha um dos quatro arquétipos corporativos abaixo para visualizar instantaneamente como o direcionamento tipográfico, paleta de cores e tom verbal moldam a percepção de status da sua marca.
              </p>
            </div>
              ...
              <div className="lg:col-span-5 bg-charcoal-900/60 border border-white/[0.05] rounded-3xl p-6 sm:p-8 flex flex-col justify-between space-y-6 text-left">
                <div className="space-y-4">
                  <span className="font-mono text-[9.5px] text-zinc-500 uppercase tracking-widest font-bold block pb-2 border-b border-white/[0.05]">
                    ESCOLHA O ARQUï¿½ï¿½ï¿½ï¿½ï¿½TIPO CORPORATIVO:
                  </span>

                  {/* Archetype buttons */}
                  {[
                    { id: "sabio", name: "O Sábio (Autoridade Clínica)", desc: "Focado em exatidão, verdade técnica e prestígio consistente. Excelente para clínicas, escritórios de advocacia e assessorias que precisam de posicionamento sólido." },
                    { id: "criador", name: "O Criador (Design & Inovação)", desc: "Estética de luxo vanguardista, quebra de convenções e originalidade absoluta. Indicado para empresas de tecnologia e startups com viés estético." },
                    { id: "governante", name: "O Governante (Legado e Solidez)", desc: "Estilo sóbrio, imperial, com viés clássico heráldico de riqueza estável. Ideal para holdings, family offices e incorporadoras premium." },
                    { id: "mago", name: "O Mago (Tecnologia Disruptiva)", desc: "Linguagem futurista e experiências quase mágicas de automação e agilidade. Perfeito para softwares de vanguarda e inteligência de dados." }
                  ].map((arch) => {
                    const isSelected = (() => {
                        ...
                        onClick={() => {
                          ...
                          if (previewCard && previewTitle && previewTagline && previewBadge && previewValues && previewFit) {
                            if (arch.id === "sabio") {
                              ...
                              previewTitle.innerText = "Clínica Dr. Gabriel MedVinci";
                              previewTagline.innerText = '"Autoridade clínica e excelência científica inabalável focado em tratamentos particulares premium."';
                              previewTagline.className = "text-zinc-400 font-sans italic text-xs leading-relaxed";
                              previewBadge.innerText = "PRESTÍGIO & EXATIDï¿½ï¿½ O";
                              ...
                              previewValues.innerText = "ï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Credibilidade Tï¿½cnica\nï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Verdade Cientï¿½fica\nï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Diagnóstico Cirï¿½rgico";
                              previewFit.innerText = "Medicina Sênior, Advocacia de Elite, Fundos de Investimento";
                              ...
                              previewTagline.innerText = '"Se o seu nicho de mercado é comum e comoditizado, altere as regras do jogo e refine seu status."';
                              ...
                              previewValues.innerText = "ï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Estética Autoral de Luxo\nï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Diferenciaï¿½ï¿½o Radical\nï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Interfaces Autorais";
                              previewFit.innerText = "Tecnologia, Startups SaaS, Agências de Marca, Estúdios";
                              ...
                              previewTagline.innerText = '"A herança invisível de faturamento sólido, blindagem patrimonial e segurança institucional soberana."';
                              previewTagline.className = "text-zinc-400 font-serif text-xs leading-relaxed";
                              previewBadge.innerText = "LEGADO & PODER HIERҁRDICO";
                              ...
                              previewValues.innerText = "ï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Solidez Geracional\nï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Alta Governanï¿½a B2B\nï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Respeito Institucional";
                              ...
                              previewTitle.innerText = "AeroCargo Logística Int.";
                              previewTagline.innerText = '"Sistemas fluidos e transformações que dissolvem atritos manuais em segundos de carregamento."';
                              previewTagline.className = "text-zinc-400 font-sans text-xs leading-relaxed";
                              previewBadge.innerText = "TRANSFORMAï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O DIGITAL // FLUIDEZ";
                              ...
                              previewValues.innerText = "ï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Experiï¿½ncia de Usuï¿½rio Fluida\nï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Engenharia Veloz\nï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Visão Revolucionï¿½ria";
                              previewFit.innerText = "SaaS Corporativos, Inteligência de Dados, Logística de Elite";
                            }
                          }
              ...
              <div className="lg:col-span-7 flex flex-col justify-center bg-[#09090b] border border-white/[0.05] rounded-3xl p-6 sm:p-8 text-left relative overflow-hidden">
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="space-y-4 my-6">
                      <h3 id="preview-title" className="text-xl sm:text-2xl text-amber-50 font-serif tracking-tight uppercase leading-tight font-medium">
                        Clínica Dr. Gabriel MedVinci
                      </h3>
                      <p id="preview-tagline" className="text-zinc-400 font-sans italic text-xs leading-relaxed">
                        "Autoridade clínica e excelência científica inabalável focado em tratamentos particulares premium."
                      </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 border-t border-white/[0.05] pt-4 text-xs font-sans">
                      <div>
                        <span className="text-zinc-500 text-[8px] block uppercase">Valores de Liderança:</span>
                        <p id="preview-values" className="text-zinc-300 text-[10px] whitespace-pre-line mt-1 font-bold leading-normal">
                          ï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Credibilidade Tï¿½cnica
                          ï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Verdade Cientï¿½fica
                          ï¿½ï¿½&ï¿½ï¿½ï¿½ï¿½ Diagnóstico Cirï¿½rgico
                        </p>
                      </div>
                      <div>
                        ...
                        <p id="preview-fit" className="text-zinc-300 text-[10px] mt-1 leading-normal font-sans">
                          Medicina Sênior, Advocacia de Elite, Fundos de Investimento
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <p className="text-[10px] text-zinc-500 font-sans text-center pt-2">
                    *Toda a tipografia, distanciamentos de logo e código de cores são compilados em um Manual de Identidade Visual de alto rigor técnico pela TAG08.
                  </p>
                </div>
              </div>
          ...
          {/* Entregáveis de um projeto completo de Branding - HIGH CONTRAST MATRIX */}
          <div className="space-y-10">
            <div className="space-y-3">
              <span className="font-mono text-[9px] text-brand-secondary uppercase tracking-widest font-semibold bg-brand-secondary/5 border border-brand-secondary/15 px-2.5 py-1 rounded-md inline-block">
                EFICIï¿½ï¿½&ï¿½NCIA CORPORATIVA
              </span>
              <h3 className="font-display font-medium text-3xl text-white uppercase tracking-tight">
                Os Arquivos e Diretrizes de Entrega
              </h3>
              <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans max-w-2xl">
                Nossos projetos estruturam todas as frentes reguladoras de branding fundamentais para certificar que os seus canais rodeiem de forma integrada e inquestionável:
              </p>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { title: "Diagnóstico Clï¿½nico", focus: "01 // ANï¿½LISE", desc: "Avaliaï¿½ï¿½o sistemï¿½tica de concorrentes e mapeamento das vulnerabilidades estéticas encontradas." },
                { title: "Posicionamento de Lideranï¿½a", focus: "02 // ESTRATï¿½ï¿½ï¿½ï¿½ï¿½GIA", desc: "Fï¿½rmula de discurso verbal exclusiva, diferenciando sua voz institucional das rï¿½plicas baratas do segmento." },
                { title: "Sï¿½mbolos e Logotipos", focus: "03 // VETORIZAï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O", desc: "Assinaturas premium criadas sob metodologias geométricas rï¿½gidas com curvas impecï¿½veis para qualquer fim." },
                { title: "Linguagem e Tom Verbal", focus: "04 // ARQUï¿½ï¿½ï¿½ï¿½ï¿½TIPOS", desc: "Manuais objetivos detalhando palavras de autoridade permitidas, vocabulï¿½rios de marca e roteiros de e-mail." },
                { title: "Manual Base de Identidade", focus: "05 // Cï¿½ï¿½ï¿½ï¿½ï¿½DIGO VISUAL", desc: "A wiki centralizada com códigos sênior exatos de tipografia, distanciamentos de arte e guias de feed." },
                { title: "Peças de Aplicação Física", focus: "06 // DESPLUGAMENTO", desc: "Layouts prontos e acabados de papelaria sênior, sacolas, cartões executivos de apresentação e fardas." }
              ].map((item, iIdx) => (
                <div key={iIdx} className="p-7 rounded-3xl bg-neutral-900/50 border border-white/[0.04] flex flex-col justify-between space-y-6 hover:border-brand-secondary/15 transition-all">
                  ...
                  <div className="pt-3 border-t border-white/[0.03] text-[9.5px] font-mono text-zinc-600">PRODUï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O TAG08_SYS</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="p-7 sm:p-9 rounded-3xl bg-neutral-900/30 border border-white/[0.05] grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative overflow-hidden">
            ...
            <div className="lg:col-span-8 space-y-3 relative z-10 text-left">
              <span className="font-mono text-[9px] text-zinc-500 uppercase tracking-widest font-black block">REBRANDING SEGURO // PRESERVAï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O HISTï¿½ï¿½ï¿½ï¿½ï¿½RICA</span>
              <h4 className="text-white font-display font-medium text-lg uppercase">Como fazemos a evolução da sua marca sem apagar seu legado</h4>
              <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans max-w-xl">
                Nós sabemos que evoluir uma imagem institucional consolidada exige extremo zelo. Nosso protocolo tï¿½cnico regula o Rebranding para conservar os pontos marcantes e herï¿½ldicos já fixados em seu nicho de mercado, readequando apenas geometrias frágeis, contrastes ineficazes e implantando a elegância do minimalismo sênior.
              </p>
            </div>
            ...
            <div className="lg:col-span-4 flex justify-start lg:justify-end relative z-10">
              <span className="font-mono text-[9px] text-brand-secondary bg-brand-secondary/5 border border-brand-secondary/15 px-4 py-2.5 rounded-xl uppercase tracking-wider font-extrabold shadow-lg">
                PATRIMï¿½ï¿½ï¿½ï¿½ï¿½NIO COGNITIVO PRESERVADO
              </span>
            </div>
          </div>
          ...
          <div className="p-8 sm:p-10 rounded-3xl bg-neutral-900/50 border border-white/[0.06] relative overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-8 text-left">
            ...
            <div className="relative z-10 space-y-2 max-w-2xl">
              ...
              <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed font-sans font-medium">
                Converse com nossos estrategistas seniores de marca e solicite um pré-diagnóstico clínico do posicionamento e valor percebido da sua identidade atual.
              </p>
            </div>
            ...
            >
              Agendar Diagnóstico Gratuito <ArrowRight className="w-4 h-4 ml-1.5 inline-block group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-5 flex flex-col justify-between space-y-8 text-left">
              <div className="space-y-4">
                ...
                <p className="text-zinc-400 text-xs sm:text-[13px] leading-relaxed font-sans max-w-sm">
                  Esclareça as principais dúvidas sobre como a TAG08 concebe e desenvolve identidades visuais corporativas sofisticadas.
                </p>
              </div>
              ...
              <div className="space-y-3 pt-4">
                {([
                  ...
                  { id: 1, title: "PROCESSO DE CRIAï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O" },
            ...
            <div className="lg:col-span-4 relative flex flex-col justify-end p-6 min-h-[380px] sm:min-h-[440px] rounded-3xl overflow-hidden border border-white/[0.04] bg-[#0c0c0e]">
              ...
              <div className="relative z-20 bg-charcoal-900/95 backdrop-blur-2xl border border-white/[0.08] p-5 rounded-2xl space-y-3 shadow-2xl text-left">
                <span className="font-mono text-[8.5px] text-brand uppercase tracking-widest font-black block">
                  {([
                    "REGISTRO DE PATENTE",
                    "PROCESSO DE CRIAï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O",
                ...
                <h4 className="text-white font-semibold text-xs sm:text-sm leading-tight border-b border-white/5 pb-2">
                  {([
                    ...
                    "Posso propor alterações no layout?",
                    "Quanto tempo demora a criação visual total?",
                ...
                <p className="text-zinc-300 text-xs sm:text-[12.5px] leading-relaxed font-sans font-medium">
                  {([
                    "A TAG08 desenha o manual, heráldica, tipografia e toda a parte visual estratégica autoral. A assessoria jurídica de registro de marca na patente do INPI é efetuada através de escritórios parceiros especialistas recomendados por nossa governança.",
                    "Certamente. Nosso fluxo prevê rodadas organizadas de refinamento intelectual durante o desenvolvimento do conceito preliminar de branding, garantindo que o resultado final reflita com perfeição sua verdade comercial e visão corporativa sênior.",
                    "Estimamos um tempo médio estrito de 30 dias úteis para a montagem de todos os estudos, curadoria intelectual de fontes e fechamento técnico do Manual de Diretrizes de Marca corporativa.",
                    "Disponibilizamos uma estrutura na nuvem contendo todos os arquivos nativos de produção vetorizados, editáveis e prontos para uso em alta definição de forma irrestrita (formatos SVG, PDF, Illustrator original e assets exportados para Figma)."
                  ])[activeFaq]}
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-3 flex flex-col justify-between gap-4">
              <div className="bg-[#121214] border border-white/5 rounded-2xl p-5 hover:border-brand/20 transition-all text-left flex flex-col justify-between space-y-4 flex-1">
                <div className="space-y-2">
                  ...
                  <p className="text-zinc-400 text-xs leading-relaxed font-sans">
                    Eliminamos marcas obsoletas que enfraquecem o prestígio comercial. Entregamos maturidade visual.
                  </p>
                </div>
                <button
              ...
              <div className="bg-brand text-black rounded-2xl p-5 hover:scale-[1.02] transition-all text-left flex flex-col justify-between space-y-4 flex-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  onClick={() => handleOutboundClick("WhatsApp", buildBrazilWhatsAppUrl("Olá,%20gostaria%20de%20consultar%20viabilidade%20estratégica%20especializada%2520para%20minha%20marca!"), "branding-viability-br")}
      ...
      <section className="px-4 sm:px-6 md:px-8 py-20 text-center space-y-6 max-w-4xl mx-auto">
        <h2 className="font-display font-black text-3xl sm:text-4xl text-white uppercase leading-none tracking-tighter">
          CONSOLIDE O PRESTҍGIO SOBERANO <br />
          <span className="text-brand">E REVERTA A PERCEPï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ O AMADORA HOJE.</span>
        </h2>
        <p className="text-zinc-400 text-xs sm:text-sm max-w-lg mx-auto leading-relaxed">
          Agende um bate-papo de escopo visual com nosso diretor estratégico sênior e desenhe detalhadamente a nova fase icônica da imagem da sua marca hoje.
        </p>
        <div className="pt-4">
          <button
            onClick={() => handleLinkClick("/contato")}
