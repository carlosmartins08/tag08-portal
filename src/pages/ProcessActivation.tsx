      ...
      <section className="px-4 sm:px-6 md:px-8 py-16 border-b border-white/[0.04] bg-charcoal-900/10 text-left">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="p-6 bg-charcoal-900 border border-white/[0.08] hover:border-brand/40 duration-300 rounded-3xl space-y-2 transition-all">
              <span className="font-mono text-[10px] text-brand uppercase font-black tracking-wider block">04 // EVAPORA??O SILENCIOSA DO M?TODO</span>
      ...
      <section className="px-4 sm:px-6 md:px-8 py-16 border-b border-white/[0.04]">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-left space-y-2 max-w-2xl">
            <span className="font-mono text-[10px] text-brand uppercase tracking-widest font-bold">PILARES DE ATIVação PRaTICA SaNIOR</span>
            ...
            <p className="text-zinc-400 text-xs sm:text-sm font-medium">
              Agimos como um vetor ativo de disciplina. Treinamos, testamos na rotina fatica e cobramos a consolidação da nova rotina com o foco na autonomia plena.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-left">
            <div className="bg-charcoal-900 border border-white/[0.08] hover:border-brand/40 duration-300 rounded-3xl p-6 space-y-4 group">
              ...
              <div className="space-y-1">
                ...
                <p className="text-zinc-400 text-[11px] sm:text-xs leading-relaxed font-medium">
                  Organizamos ritos pr?ticos de introdu??o por meio de checklists din?micos no dia a dia do colaborador, vinculando as wikis aos cards de tarefas reais de forma r?pida.
                </p>
              </div>
            </div>
            ...
            <div className="bg-charcoal-900 border border-white/[0.08] hover:border-brand/40 duration-300 rounded-3xl p-6 space-y-4 group">
              ...
              <div className="space-y-1">
                ...
                <p className="text-zinc-400 text-[11px] sm:text-xs leading-relaxed font-medium">
                  A rotina pratica esbarra em atritos inevitaveis. Customizamos e polimos as regras e os playbooks de forma org?nica de acordo com o crescimento real das suas divisaes t?ticas.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-1 max-w-3xl">
            ...
            <p className="text-zinc-400 text-xs font-sans font-medium leading-relaxed">
              O Process Activation cria a verdadeira cultura operacional de autonomia. Traga a segurança intelectual de que o seu time consegue conduzir com maestria as atividades de venda, suporte e faturamento na sua ausancia.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto space-y-12 relative z-10">
          <div className="space-y-3 max-w-3xl">
            <span className="font-mono text-[9px] text-brand-secondary uppercase tracking-widest font-black bg-brand-secondary/5 border border-brand-secondary/15 px-2.5 py-1 rounded-md inline-block">
              METODOLOGIA ATIVA // ROADMAP DE EXECU??O
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 bg-charcoal-900/60 border border-white/[0.05] rounded-3xl p-6 sm:p-8 flex flex-col justify-between space-y-8 text-left">
              <div className="space-y-6">
                ...
                {/* Level Selectors */}
                {[
                  { id: "bronze", name: "Bronze // Operação Caatica", desc: "Processos na cabeça das pessoas, planilhas desorganizadas, WhatsApp misturado e fundadores como gargalo diario de dúvidas." },
                  { id: "prata", name: "Prata // Organização Loose", desc: "Alguns playbooks escritos mas desatualizados, ferramentas como Trello e Notion com uso inconsistente pela equipe." },
                  { id: "ouro", name: "Ouro // Automação Pronta", desc: "Deseja integrar sistemas em tempo real (CRMs, ERPs, Chatbots) e certificar que o time execute tudo sem atrito." }
                ].map((lvl) => {
              ...
              <div className="space-y-6 w-full">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { step: "FASE 3", title: "Automa??o Operacional e Treinamentos", desc: "Sess?es din?micas de handoff com toda a equipe, ajustes ao vivo nos sistemas, grava??o de v?deos curtos explicativos de 3 minutos.", badge: "W3 - W4" },
                ...
                __html: `
                  (function() {
                    window._updateRoadmap = function() {
                      ...
                      if (lvl === "bronze") {
                        if (durEl) durEl.innerText = "DURação: 4 SEMANAS";
                        if (t0) t0.innerText = "Mapeamento e Diagnastico Clanico";
                        if (d0) d0.innerText = "Entrevistas com equipe de holding e comercial, catalogação de gargalos de tempo e desenho do mapa inicial.";
                        if (b0) b0.innerText = "Semana 1";

                        if (t1) t1.innerText = "Escrita de Playbooks e Criação de Wikis";
                        if (d1) d1.innerText = "Estruturação das wikis de ferramentas, senhas de equipe, roteiros de onboarding e criação de playbooks visuais no Notion.";
                        if (b1) b1.innerText = "Semana 2";

                        if (t2) t2.innerText = "Sessões Ativas e Treinamentos Curtos";
                        if (d2) d2.innerText = "Sess?es din?micas de handoff com toda a equipe, grava??o de v?deos curtos explicativos de 3 minutos para fixa??o.";
                        if (b2) b2.innerText = "Semana 3";

                        if (t3) t3.innerText = "Auditoria de Disciplina e Adesão";
                        if (d3) d3.innerText = "Auditoria ativa diária para verificar conformidade com planilhas, novos canais e fluxos, ajustando atritos práticos.";
                        if (b3) b3.innerText = "Semana 4";
                      } else if (lvl === "prata") {
                        if (durEl) durEl.innerText = "DURação: 6 SEMANAS";
                        if (t0) t0.innerText = "Inventario de Sistemas e Auditoria de Processos";
                        if (d0) d0.innerText = "Mapeamento das ferramentas ativas (CRMs, Trello, Planilhas), identificação de dados duplicados e furos de follow-up.";
                        if (b0) b0.innerText = "Semana 1 - 2";

                        if (t1) t1.innerText = "Reestruturação e Atualização de Wikis";
                        if (d1) d1.innerText = "Consolidação de uma Wiki Central soberana e reformulação de fluxos confusos. Limpeza de checklists antigos.";
                        if (b1) b1.innerText = "Semana 2 - 3";

                        if (t2) t2.innerText = "Integração de Alertas e Automação Basica";
                        if (d2) d2.innerText = "Criação de automações leves de notificação por WhatsApp/Slack para alerts urgentes de leads abandonados.";
                        if (b2) b2.innerText = "Semana 4 - 5";

                        if (t3) t3.innerText = "Simulados Práticos de Ativação";
                        if (d3) d3.innerText = "Treinamento intensivo da equipe comercial sob cenários reais, certificando adoção de 100% das novas regras de CRM.";
                        if (b3) b3.innerText = "Semana 6";
                      } else {
                        if (durEl) durEl.innerText = "DURação: 8 SEMANAS";
                        if (t0) t0.innerText = "Arquitetura de Dados e Blueprint API";
                        if (d0) d0.innerText = "Desenho técnico do fluxo de informações entre ERP, CRMs, WhatsApp Cloud API e banco de dados analítico.";
                        if (b0) b0.innerText = "Semana 1 - 2";

                        if (t1) t1.innerText = "Desenvolvimento de Automações Nativas (n8n/Make)";
                        if (d1) d1.innerText = "Codificação e desenvolvimento dos fluxos de integração automática, Webhooks e gatilhos de sincronização constante.";
                        if (b1) b1.innerText = "Semana 3 - 5";

                        if (t2) t2.innerText = "Simulados e Tratamento de Erros";
                        if (d2) d2.innerText = "Fase de testes de estresse, implementação de alertas de erro automáticos e manuais de contingência operacional.";
                        if (b2) b2.innerText = "Semana 6 - 7";

                        if (t3) t3.innerText = "Handoff Técnico e Ativação Operacional";
                        if (d3) d3.innerText = "Entrega dos fluxogramas, documentação de APIs, painel de monitoramento e treinamento do encarregado interno de sistemas.";
          ...
          <div className="space-y-8 pt-10 border-t border-white/[0.04]">
            <div className="space-y-2">
              ...
              <p className="text-zinc-400 text-xs sm:text-sm font-sans leading-relaxed max-w-2xl">
                A ades?o aos manuais do seu neg?cio ocorre por insist?ncia e const?ncia anal?tica. Nosso time executa um cronograma est?vel e repetitivo nos bastidores:
              </p>
            </div>
            ...
            <div className="lg:col-span-5 flex flex-col justify-between space-y-8 text-left">
              <div className="space-y-4">
                ...
                <p className="text-zinc-400 text-xs sm:text-[13px] leading-relaxed font-sans max-w-sm">
                  Esclareaa as principais dúvidas sobre como nossa metodologia ativa os playbooks estruturais na rotina real dos colaboradores.
                </p>
              </div>
              ...
              <div className="relative z-20 bg-charcoal-900/95 backdrop-blur-2xl border border-white/[0.08] p-5 rounded-2xl space-y-3 shadow-2xl text-left">
                ...
                <p className="text-zinc-300 text-xs sm:text-[12.5px] leading-relaxed font-sans font-medium">
                  {([
                    ...
                    "Promovemos workshops din?micos assistidos voltados ao uso correto das ferramentas, criamos rotinas com checklists visuais de tarefas di?rias e conectamos as bases de senhas diretas ? mesa de trabalho produtiva de cada colaborador.",
