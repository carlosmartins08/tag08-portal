...
export default function HospedagemManutencaoSites({ onNavigate }: PageProps) {
  ...
  const hostingTypes = [
    ...
    },
    {
      ...
      niche: "Startups, aplicações SaaS escaláveis, trafego dinâmico",
      category: "corporativo",
    ...
    },
    {
      ...
      category: "especializado",
      description: "Suate integrada para garantir que nenhum carrinho de compras seja abandonado por lentidao técnica. Suporte nativo a múltiplos gateways de pagamentos criptografados, selos dinâmicos de segurança e barreira de proteção robusta.",
  ...
  const journeySteps = [
    {
      ...
      description: "Imagine os servidores como titas de processamento operando dentro de data centers de segurança maxima. Eles são guardiaes de alta performance que nunca adormecem, alimentados por canais de energia redundante para manter seus arquivos vivos a cada fração de milissegundo.",
      metric: "99.99% Uptime Seguro"
    },
    {
      id: 1,
      title: "Os Sentinelas de Fronteira",
      label: "PROTOCOLOS DE SEGURAN�!A",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 space-y-20 md:space-y-32">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 text-left">
          <div className="lg:col-span-5 space-y-6 flex flex-col justify-center">
            ...
            <p className="text-zinc-400 text-sm sm:text-base leading-relaxed font-sans font-medium">
              No vasto oceano digital da internet, seu site enfrenta tempestades mecânicas silenciosas todos os dias. Para garantir que ele resista com altivez soberana, aplicómos uma filosofia de equilabrio perfeito.
            </p>
            <p className="text-zinc-400 text-sm sm:text-base leading-relaxed font-sans font-medium">
        ...
        <section className="space-y-12 text-left">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <h2 className="font-display font-black text-3xl sm:text-4xl text-white uppercase tracking-tighter leading-none">
              PROCESSOS CONT�NUOS DE PROTE�!ÒO &amp; OTIMIZA�!ÒO.
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-8 rounded-[28px] bg-white/[0.01] border border-white/[0.04] space-y-6 hover:border-brand/15 transition-all duration-300">
              ...
              <ul className="space-y-2 pt-2 border-t border-white/5 text-[11px] text-zinc-450 font-sans">
                ...
                <li className="flex items-center gap-1.5"><CheckCircle2 className="w-3.5 h-3.5 text-brand shrink-0" /> Emissão de Relatarios Claros</li>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.04] space-y-1 text-left">
                    ...
                    <p className="text-zinc-455 text-[10.5px] font-sans leading-tight mt-1.5">
                      Processadores de múltiplos nacleos para manter seu site rodando com carregamentos estaveis e ausancia total de lentidao.
                    </p>
                  </div>
                  {/* Tech indicator 2 */}
                  <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.04] space-y-1 text-left">
                ...
                <div className="space-y-3">
                  <div className="p-3.5 rounded-xl bg-white/[0.01] hover:bg-white/[0.02] border border-white/5 hover:border-brand/20 transition-all flex items-start gap-3">
                    ...
                    <div className="space-y-0.5">
                      <h4 className="text-white text-xs sm:text-sm font-display font-black uppercase">Firewalls e Detecaao de Intrusão</h4>
              ...
              {[
                {
                  ...
                  resources: [
                    ...
                    { label: "Trafego Mensal", value: "500 GB de Volume", tooltip: "Banda larga de dados expansiva apta para resistir a navegação constante de milhares de visitantes." },
                    ...
                    { label: "Certificação SSL", value: "Let's Encrypt Incluso", tooltip: "Criptografia HTTPS de segurança maxima ativa para proteção de dados sensaveis e melhor ranqueamento no algoritmo de buscas." },
                  ]
                },
                {
                  id: "intermediario",
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className={`mt-4 pt-3 border-t border-white/[0.04] text-center font-mono text-[8px] uppercase font-black tracking-widest transition-all ${
                          ...
                          {isActive ? "? SOLUaaO ACOPLADA AO TRABALHO DE CUSTOMIZação" : "[-] CLIQUE SELECIONAR E CUSTOMIZAR"}
                        </div>
                      </div>
                    );
                  })}
                      ...
                      >
                        ...
                        <div className="space-y-1 flex-1">
                          ...
                          <p className="text-xs text-zinc-400 font-sans leading-snug">
                            {simPlan === "basico" && "Correaao técnica preferencial e monitoramento de indisponibilidade de forma ativa."}
                            {simPlan === "intermediario" && "Criação de backup adicional guardado em segundo data-center independente (proteção maxima)."}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3 font-sans text-zinc-400 text-xs pb-4 border-b border-dashed border-white/10">
                      ...
                      <div className="pt-2 text-[9px] leading-relaxed text-zinc-550 font-sans border-t border-white/[0.04] mt-2">
                        ? Integrado por Definiaao: Isolação cPanel/WHM, SSL Criptografico Ilimitado, Mitigação Ativa de DDoS e Trafego Mensal Integridade.
                      </div>
                    </div>
                    ...
                    <div className="bg-[#121214]/60 border border-white/5 p-4 rounded-2xl space-y-2 transition-all">
                      ...
                      <p className="text-[11px] text-zinc-400 font-sans leading-relaxed">
                        {simPlan === "basico" && simStorage <= 15 && (
                          "Gargalo Técnico: Baixo. Excelente relação custo-benefacio para marcas novas que validam landing pages e sistemas basicos."
                        )}
                        {simPlan === "basico" && simStorage > 15 && (
                        ...
                        {simPlan === "intermediario" && simSites <= 1 && (
                          "Diagnastico Avanaado: Configuração corporativa equilibrada. Salido para portais comerciais que dependem de constância em SEO e carregamentos menores que 1.2 segundos."
                        )}
                        {simPlan === "intermediario" && simSites > 1 && (
 ...
 - COBERTURA EXTRA TaCNICA: ${simApplyUpgrade ? "Ativado" : "Não ativado"}
              ...
              <div className="lg:col-span-5 flex flex-col justify-between space-y-8 text-left">
                <div className="space-y-4">
                  ...
                  <p className="text-zinc-400 text-xs sm:text-[13px] leading-relaxed font-sans max-w-sm">
                    Esclareaa as principais dúvidas sobre nossa divisão técnica de infraestrutura, servidores dedicados e otimização contínua de código.
                  </p>
                </div>
                ...
                <div className="bg-[#121214] border border-white/5 rounded-2xl p-5 hover:border-brand/20 transition-all text-left flex flex-col justify-between space-y-4 flex-1">
                  <div className="space-y-2">
                    ...
                    <p className="text-zinc-400 text-xs leading-relaxed font-sans">
                      Eliminamos lentidao excessiva e falha técnica cranica. Garantimos maxima performance de seus servidores.
                    </p>
                  </div>
                  <button
