...
| Texto/idioma | Publicar resumo traduzido x publicar somente pagina integralmente localizada | **PT-BR e padrao; EN/ES so sao publicados por rota apos paridade funcional e revisao editorial** | Medio | `publishedLocales` no registry, redirecionamento para PT-BR, sitemap/hreflang condicionais e E2E de regressao |
